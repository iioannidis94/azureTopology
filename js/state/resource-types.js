...
export const RES_TYPES={
  vm:{icon:'💻', img:'virtual-machines.svg', color:'#00BCF2',label:'Virtual Machine',cat:'compute', cost: 85, config:{size:'Standard_D2s_v3',os:'Ubuntu 22.04',osDisk:{type:'Premium_LRS',sizeGB:'128',caching:'ReadWrite',createOption:'FromImage'},dataDisks:[],nics:[{name:'',enableAcceleratedNetworking:'true',enableIPForwarding:'false',primary:'true',privateIPAllocationMethod:'Dynamic',privateIPAddress:'',publicIp:'false'}],authType:'SSH Key',availabilityZone:'None',bootDiagnostics:'true',managedIdentity:'SystemAssigned',backupEnabled:'false',patchMode:'AutomaticByPlatform',securityType:'TrustedLaunch',vTpmEnabled:'true',secureBootEnabled:'true'}},
  ...
  pe:{icon:'🔌', img:'private-endpoint.svg', color:'#8764B8',label:'Private Endpoint',cat:'network', cost: 10, config:{target:'Storage',groupId:'blob',privateDnsZoneId:'',connectionName:'',subResource:'blob',targetResourceId:'',targetResourceName:'',nics:[{name:'',enableAcceleratedNetworking:'false',enableIPForwarding:'false',privateIPAllocationMethod:'Dynamic',privateIPAddress:''}]}},
